...
import java.net.URL;
public class CT02REQ001CadastroComIsbnJaCadastradoTest {
  ...
  @Test
  public void cT02REQ001CadastroComIsbnJaCadastrado() {
    ...
    driver.findElement(By.id("isbn")).sendKeys("9996");
    driver.findElement(By.id("autor")).click();
    driver.findElement(By.id("autor")).sendKeys("Gnome");
    driver.findElement(By.id("titulo")).sendKeys("Como vencer em jogos online");
